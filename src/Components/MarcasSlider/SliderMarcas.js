...
export default class SimpleSlider extends Component {
  render() {
    ...
    return (
      <div className='flex flex-col max-w-[1376px] border-2 items-center my-[100px] justify-center overflow-hidden-x mx-auto px-3 max-h-[320px]'>
        <h2 className="font-semibold text-gray-900 lg:relative lg:text-[1.3rem] lg:top-[50px]"> Nuestras marcas</h2>
