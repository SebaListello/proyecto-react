...
const MenuMobileOptions = ({openClose,transition}) => {
  return (
    <div onClick={openClose} className={`md:hidden absolute w-full bg-black top-[10%] transform transition duration-200 flex justify-center items-center py-[3%] ${transition}`}>
