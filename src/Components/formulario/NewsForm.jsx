    ...
    <div className='bg-black  min-h-[35vh] sm:h-[35vh] mt-[200px]'>
        ...
        <div className="container h-full mx-auto grid sm:grid-cols-2 items-center p-5 gap-x-10">
            <div className="Form___text p-10">
                <h2 className='uppercase text-white text-2xl text-center sm:text-left'>Subscribite y <span className='text-[#fb953c]'>enterate de las oportunidades </span> de sportswear</h2>
            </div>
            ...
            <form action='#'>
                ...
                <div class="relative z-0 mb-6 w-full group flex">
                    ...
                    <button type="button" class="text-white focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium  text-sm px-5 py-2.5 text-center dark:bg-orange-600 dark:hover:bg-orange-300 dark:focus:ring-orange-800">Submit</button>
                </div>
            </form>
        </div>
    </div>
