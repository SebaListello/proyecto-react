...
export const MoreBrands = () => {
  return (
    <div className='moreBrands__container container mx-auto w-full '>

        <div className='grid place-items-center grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
            {moreBrands.map((brand) => (
                <div className="moreBrands__card border-round rounded-lg max-w-[350px] transition duration-200 ease-in-out hover:scale-[1.05] shadow hover:shadow-lg outline-none border-none overflow-hidden"> 
                    <a href="#">
